...
from testcases_canlin.bootloader.utils.bootloader_lin_utils import get_flash_config, main_flash, \
...
from testcases_canlin.uds.lin_test_pre_module import monitor_lin_communication, create_lin_sch
...
def test_TG1_TC6_2E_WriteDataAfterFlashTest():
    ...
    try:
        ...
        from testcases_canlin.bootloader.utils.bootloader_lin_utils import make_fingerprint
