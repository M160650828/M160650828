...
from testcases_canlin.nm.nm_module import (
...
from testcases_canlin.nm.nm_autosar_utils import (
...
def test_TG1_TC3_AbnormalWakeupSourceTest():
    ...
    try:
        ...
        from testcases_canlin.nm.nm_autosar_utils import wait_nm_message
